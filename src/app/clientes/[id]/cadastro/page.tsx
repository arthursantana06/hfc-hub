...
/**
 * O cadastro saiu de dentro do Ponto de Partida e virou item do menu.
 *
 * Ele não é uma etapa do raio-x: é quem a pessoa é. Ficava escondido atrás de
 * uma aba de planejamento, e era o primeiro lugar em que se precisava entrar.
 */
  ...
  return (
    <>
      <header className="p-8 pb-6 shrink-0 border-b border-slate-200/60 bg-white shadow-sm z-0">
        <h1 className="font-poppins font-medium text-2xl text-brand-950">Cadastro</h1>
        <p className="font-inter text-sm text-slate-500 mt-1">
          Quem é o cliente e sob que premissas o plano dele roda.
        </p>
      </header>
          ...
          <Card titulo="Premissas do plano" icone={Settings2} tom="roxo">
            {!plano && (
              <p className="font-inter text-sm text-slate-500 mb-5 bg-slate-50 border border-slate-100 rounded-lg px-3 py-2.5">
                Este cliente ainda não tem plano. Crie um aqui — sem ele,
                receitas, custos e mudanças não têm onde ser gravados. O mês que
                você escolher vira o ponto de partida.
              </p>
            )}
